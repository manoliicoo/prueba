...
while not hecho:
    ...
    for evento in pygame.event.get():
        ...
        # Establecemos la velocidad basandonos en la tecla presionada
    ...
    # .pop() este comando elimina el ultimo objeto de una lista.
    segmento_viejo = segementos_dela_serpiente.pop()
    listade_todoslos_sprites.remove(segmento_viejo)
     
    # Determinamos donde aparecera el nuevo segmento
